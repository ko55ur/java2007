...
import course3.homework6.chat.client.net.MessageProcessor;
import course3.homework6.chat.client.net.NetworkService;
    ...
    private void parseIncomingMessage(String message) {
        ...
        switch (splitMessage[0]) {
            ...
            case "/list":
                ...
                contacts.add("ALL");
                contacts.addAll(Arrays.asList(splitMessage).subList(1, splitMessage.length));
