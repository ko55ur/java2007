package course2.lesson8.chat.server.service.impl;


import course2.lesson8.chat.server.error.NickAllreadyIsBusyException;
import course2.lesson8.chat.server.error.UserNotFoundException;
import course2.lesson8.chat.server.error.WrongCredentialsException;
import course2.lesson8.chat.server.model.User;
import course2.lesson8.chat.server.service.UserService;
...
//            if (Objects.equals(login, user.getLogin()) && Objects.equals(password, user.getPassword())) {
    ...
    public String changeNick(String oldNick, String newNick) {
        if (isNickBusy(newNick)) {
            throw new NickAllreadyIsBusyException();
        }
